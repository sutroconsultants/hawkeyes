...
const systemInstructions = `You help users query East Bay Water Authority data in ClickHouse.
...
- hydrants, hydrant_inspections, valves, valve_exercises, mains, main_breaks, pressure_zones, critical_users, claims, documents

When answering questions, directly use execute_clickhouse_query with a SQL query like:
SELECT * FROM eastbay_water.work_orders WHERE priority = 'emergency' LIMIT 100
