...
export const QueryConfirmationPropsSchema = z.object({
  sql: z.string().describe("The complete SQL query to execute. Example: 'SELECT * FROM ebmud.work_orders WHERE priority = \\'emergency\\' LIMIT 100'. This MUST contain the actual query text."),
